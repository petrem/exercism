...
def test_polirange():
    assert list(_polirange(0, 13, (6, ))) == [0, 6, 12]
    assert list(_polirange(0, 13, (6, 0))) == [0, 6, 12]
    assert list(_polirange(1, 13, (4, 2))) == [1, 5, 7, 11]
    assert list(_polirange(2, 13, (2, 4))) == [2, 4, 8, 10]
