...
def test_to_base(conversion):
    base, number, digits = conversion
    assert to_base(base, number) == digits


def test_from_base(conversion):
    base, number, digits = conversion
    assert from_base(base, digits) == number
