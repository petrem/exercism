...
def check_drinks(drink_name, drink_ingredients):
    ...
    label = "Cocktail" if ALCOHOLS.intersection(drink_ingredients) else "Mocktail"
    return f"{drink_name} {label}"
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for category, ingredients in _CATEGORIES.items():
        if ingredients.issuperset(dish_ingredients):
            return f"{dish_name}: {category}"
    raise ValueError("I'm appaled!")
